...
<div id="ng-left"><div class="ng-track"><div class="ng-fill" id="ng-left-fill" style="height:100%"></div></div><div class="ng-icon" id="ng-bright-icon"></div></div>
<div id="ng-right"><div class="ng-track"><div class="ng-fill" id="ng-right-fill" style="height:80%"></div></div><div class="ng-icon" id="ng-vol-icon"></div></div>
<div id="ng-toast"></div>
